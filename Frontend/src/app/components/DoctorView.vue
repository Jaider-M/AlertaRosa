      ...
      >
        <div :key="activeTab">
          <template v-if="activeTab === 'dashboard'">
            <!-- <Dashboard /> -->
            <p>Dashboard View (Pendiente de migrar)</p>
          </template>
          <template v-if="activeTab === 'diagnosis'">
            <!-- <DiagnosisModule /> -->
            <p>Diagnosis Module (Pendiente de migrar)</p>
          </template>
          <template v-if="activeTab === 'patients'">
            <!-- <PatientManagement /> -->
            <p>Patient Management (Pendiente de migrar)</p>
          </template>
          <template v-if="activeTab === 'analytics'">
            <!-- <Analytics /> -->
            <p>Analytics View (Pendiente de migrar)</p>
          </template>
          <template v-if="activeTab === 'alerts'">
            <!-- <PatientAlerts /> -->
            <p>Patient Alerts View (Pendiente de migrar)</p>
          </template>
        </div>
      </transition>
    </main>
